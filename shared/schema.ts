...
export const certifications = pgTable("certifications", {
  ...
  categoria: text("categoria").notNull().default("geral"), // geral, pos_graduacao, segunda_graduacao, formacao_livre, eja, graduacao, diplomacao_competencia, capacitacao, sequencial
